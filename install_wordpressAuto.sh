...
sudo apt -y update
sudo apt -y install php-curl php-gd php-mbstring php-xml php-xmlrpc apache2 php libapache2-mod-php
...
sudo sed -i "359s/.*/\t\t\$weblog_title = 'Bruno';/" /var/www/html/wordpress/wp-admin/install.php
